			...
			<form id="search">
				...
				<div class="search-wrapper">
					<div class="field location-search">
						<input id="address-input" class="border-main-color" type="text" placeholder="Enter suburb, town, city or postcode" />
						<div class="search-category raido-checkbox radio">
							<ul class="list-unstyled">
							  <li>
							    <input type="radio" id="f-option" name="selector-category" checked>
							  ...
							  <li>
							    <input type="radio" id="s-option" name="selector-category">
							  ...
							  <li>
							    <input type="radio" id="t-option" name="selector-category">
